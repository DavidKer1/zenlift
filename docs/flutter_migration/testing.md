...
- Current scaffold test command: `cd flutter-version && flutter test` passes for bootstrap and theme-token tests.
- Current scaffold analyze command: `cd flutter-version && flutter analyze` passes after the minimal router and theme files were added.
