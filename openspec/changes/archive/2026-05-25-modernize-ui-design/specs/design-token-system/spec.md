...
Centralized design tokens matching DESIGN.md—colors, typography scale, spacing, border radius, and surface elevation levels for the monochromatic tonal design system.
