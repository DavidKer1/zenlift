...
GoRouter buildTestRouter({String initialLocation = ZenliftRoutes.home}) {
  return buildZenliftRouter(
    ...
    routineDetailBuilder: (context, routineId) => _RoutineDetailRouteStub(
      key: ZenliftRouteKeys.routineDetailScreen,
      routineId: routineId,
    ),
    routineCreateBuilder: (context) => const _RoutineCreateRouteStub(
      key: ZenliftRouteKeys.routineCreateScreen,
    ),
    routineEditBuilder: (context, routineId) => _RoutineEditRouteStub(
    ...
    workoutSummaryBuilder: (context) => const _WorkoutSummaryRouteStub(
...
class _RoutineDetailRouteStub extends StatelessWidget {
  const _RoutineDetailRouteStub({required this.routineId, super.key});
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [const Text('Routine detail'), Text(routineId)],
        ),
      ),
    );
  }
...
class _RoutineCreateRouteStub extends StatelessWidget {
  const _RoutineCreateRouteStub({super.key});

  @override
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Create routine')));
  }
}

class _RoutineEditRouteStub extends StatelessWidget {
  const _RoutineEditRouteStub({required this.routineId, super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [const Text('Edit routine'), Text(routineId)],
        ),
      ),
    );
  }
...
class _HistoryRouteStub extends StatelessWidget {
  const _HistoryRouteStub({super.key});
...
class _ExerciseLibraryRouteStub extends StatelessWidget {
  const _ExerciseLibraryRouteStub({super.key});
...
class _WorkoutSummaryRouteStub extends StatelessWidget {
  const _WorkoutSummaryRouteStub({super.key});

  @override
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Workout summary')));
  }
}
